...
cleos -u $url multisig propose issue '[{"actor": "staider11111", "permission": "active"},{"actor": "volentixdev2", "permission": "active"}]' '[{"actor": "volentixgsys", "permission": "active"}]' volentixgsys issue '{"to": "vtxcontribut", "quantity": "156000000.00000000 VTX", "memo": ""}' -p volentixdev2@active;
