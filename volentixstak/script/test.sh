...
# cleos -u $apiEndpoint push action volentixstak addblacklist '{"symbol": "8,TEST", "account": "vtxtestacc11"}' -p volentixstak

# Remove account from blocklist
# cleos -u $apiEndpoint push action volentixstak rmblacklist '{"symbol": "8,TEST", "account": "vtxtestacc11"}' -p volentixstak
...
######## Auth check ########
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxtestacc11", "to":"volentixstak", "quantity":"1000.00000000 TEST", "memo": 30}' -p vtxtestacc12

######## Must be positive amount ########
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxtestacc11", "to":"volentixstak", "quantity":"0.00000000 TEST", "memo": 30 }' -p vtxtestacc11
...
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxtestacc11", "to":"volentixstak", "quantity":"1000.0000 TEST", "memo": 30 }' -p vtxtestacc11

######## Check Amount Exceeding require Limit ########
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxcontract1", "to":"volentixstak", "quantity":"10000000001.00000000 TEST", "memo": 30 }' -p vtxcontract1

######### Check account overdraw stake #########
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxtestacc11", "to":"volentixstak", "quantity":"10000000000.00000000 TEST", "memo": 30 }' -p vtxtestacc11

####### no balance object found in lock_accounts (Must test with new account) #######
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxtestacc13", "to":"volentixstak", "quantity":"10000000000.00000000 TEST", "memo": 30 }' -p vtxtestacc13

############################ Staking amount checks ##########################

# staking amount should be greater than 1000
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxtestacc11", "to":"volentixstak", "quantity":"100.00000000 TEST", "memo": 30 }' -p vtxtestacc11

######### staking amount should be less than 10000000 ###########
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxtestacc11", "to":"volentixstak", "quantity":"10000001.00000000 TEST", "memo": 30 }' -p vtxtestacc11

############ Staking period checks ##############

######## staking period should be multiple of 30 ######
# cleos -u $apiEndpoint push action vtxcontract1 transfer '{"from":"vtxtestacc11", "to":"volentixstak", "quantity":"1000000.00000000 TEST", "memo": 80 }' -p vtxtestacc11
