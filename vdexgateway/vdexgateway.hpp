...
public:
   ...
   [[eosio::action]] 
   void confirmdep(name node, name account, checksum256 tx_hash);
   ...
   [[eosio::action]] 
   void newwithdraw(name account, asset amount, uint64_t id);

   [[eosio::action]] 
   void lockwithdraw(name node, name account, uint64_t withd_id);
   
   [[eosio::action]] 
   void submitwithd(name node, name account, uint64_t withd_id, checksum256 tx_hash);
   
   [[eosio::action]] 
   void confirmwithd(name node, name account, checksum256 tx_hash);
