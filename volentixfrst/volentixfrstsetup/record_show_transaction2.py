...
if __name__ == '__main__':
    ...
    for i in range(1,100):                                                                                                            
        ...
        object = '["bleb", "blob", "blub", 100000.00000000, "EOS333333333333", "manual-SC", "nonce"]'
        out = subprocess.check_output(['cleos', '--url', blockchain.producer, 'push', 'action', account.name, 'rcrdtfr', object, '-p', '114vtxledger' + '@active'])
