...
void distribution::paycore() {}
void distribution::paycampaign(string campaign) {}


void distribution::setrewardrule(uint32_t reward_id, asset reward_amount, double votes_threshold, uint32_t uptime_threshold, uint32_t uptime_timeout){
...
void distribution::addnode(name account) {
...
void distribution::removenode(name account) {
    require_auth( account );
...
void distribution::uptime(name account) {
	require_auth( account );
...
EOSIO_DISPATCH(distribution, (setrewardrule)(addnode)(removenode)(uptime))